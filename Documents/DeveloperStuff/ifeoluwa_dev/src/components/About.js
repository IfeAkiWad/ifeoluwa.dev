...
const About = () => {
  return (
    <div id='about-container'>
      <div>
        <a className='socials' href = {ResumePDF}>
          <button>
            Résumé
          </button>
        </a>
        <a className='socials' href='https://github.com/IfeAkiWad'>
          <button>
            Github
          </button>
        </a>
        <a className='socials' href='https://www.linkedin.com/in/ifeoluwa-akinremi-wade/'>
          <button>
            LinkedIn
          </button>
        </a>
        <a className='socials' href='https://medium.com/@ifeoluwa-akinremi'>
          <button>
            Blogs
          </button>
        </a>
